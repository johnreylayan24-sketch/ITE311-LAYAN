                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Student Dashboard</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="#" class="list-group-item list-group-item-action">
                            ...
                            <p class="mb-1">Math 101 - Chapter 3 Homework</p>
                        ...
                        <a href="#" class="list-group-item list-group-item-action">
                            ...
                            <p class="mb-1">Science 101 - Midterm Exam</p>
                            <small class="text-muted">Grade: 92/100 (A-)</small>
                        </a>
                        <a href="#" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-between">
                            ...
                            <p class="mb-1">History 101 - Lecture Slides</p>
                            <small class="text-muted">Chapter 4: World War II</small>
                        </a>
                    </div>
                </div>
            </div>
